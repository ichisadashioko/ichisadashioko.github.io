...
namespace TicTacToe {
    ...
    export class Game {
        ...
        mouseupListener: (evt: MouseEvent) => void
        ...
        run() {
            ...
            let numDrawCalls = this.floatToInt(this.loadingTimeout / this.fps)
            ...
            for (let i = 0; i < numDrawCalls; i++) {
                ...
                setTimeout(function () {
                    ...
                    safeThreadVars._this.renderLoadingScreen.bind(safeThreadVars._this)(safeThreadVars.alpha)
                }, safeThreadVars.drawAfter)
            }
